...
Future<void> fetchUserProfile(BuildContext context) async {
  ...
  Repository repo = await github.repositories.getRepository(RepositorySlug("Superalgos", "superalgos"));
...
class SuperAlgoApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(title: 'Superalgos', home: LoginScreen());
  }
}
