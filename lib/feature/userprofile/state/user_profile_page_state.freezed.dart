...
part of 'user_profile_page_state.dart';
...
class _$_Loading with DiagnosticableTreeMixin implements _Loading {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'UserProfilePageState.loading()';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'UserProfilePageState.loading'));
  }
...
class _$_LoggedOut with DiagnosticableTreeMixin implements _LoggedOut {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'UserProfilePageState.loggedOut()';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'UserProfilePageState.loggedOut'));
  }
...
abstract class _LoggedOut implements UserProfilePageState {
